 ...
 **1. Start MySQL:** ตรวจสอบให้แน่ใจว่า MySQL service ของคุณกำลังรันอยู่

 **2. Set Environment:** ตรวจสอบไฟล์ ```.env``` และแก้ไข ```DB_DSN``` ให้ชี้ไปที่ localhost ของคุณ

```
DB_DSN=admin:your_admin_secret_password@tcp(localhost:3306)/turtle_db?charset=utf8mb4&parseTime=True&loc=
```
